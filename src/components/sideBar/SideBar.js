...
export default function SideBar() {
  ...
  const productMenus = [
    { label: "Trending", category: "trending", icon: <FaBoxOpen /> },
    { label: "Popular", category: "popular", icon: <FaStar /> },
    { label: "Electric", category: "electric", icon: <FaBolt /> },
    { label: "Adventure", category: "adventure", icon: <FaMotorcycle /> },
    { label: "Scooters", category: "scooter", icon: <GiScooter /> },
    { label: "Best Mileage Bike", category: "best-mileage", icon: <FaGasPump /> },
    { label: "Sports", category: "sports", icon: <FaRoad /> },
    { label: "Cruiser", category: "cruiser", icon: <FaMotorcycle /> },
  ];
            ...
            >
              <ul className="ml-6 space-y-1">
                {productMenus.map((item, idx) => (
                  <li
                    key={idx}
                    className={`flex items-center gap-2 p-2 rounded cursor-pointer hover:bg-teal-600 ${
                      currentCategory === item.category
                        ? "bg-teal-600 font-semibold"
                        : ""
                    }`}
                    onClick={() =>
                      router.push(`/admin/bike-list?category=${item.category}`)
                    }
                  >
                    {item.icon}
                    <span>{item.label}</span>
